 ...
 */
class GAECommerceCartAddRequestTest extends TestCase
{

    public function test__construct(): void
    {
        Analytics::init();
        $req = new GAECommerceCartAddRequest([new Product("id", new Money(300, new Currency("EUR")), new Money(250, new Currency("EUR")), "key", "name", "category", "variant", "brand", 2, "coupon")]);
        ...
        self::assertEquals("add_to_cart", $req->getParameters()[GAParameter::$EVENTACTION->getName()]);
        self::assertEquals(1, $req->getParameters()[GAParameter::$EVENTVALUE->getName()]);

        self::assertEquals("add", $req->getParameters()[GAParameter::$PRODUCTACTION->getName()]);
