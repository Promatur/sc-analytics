...
/**
 * Class GAECommerceCartAddRequest. Sent, when adding one or more products to a shopping cart.
 *
 ...
 */
class GAECommerceCartAddRequest extends GAEventRequest
{
    ...
    {
        parent::__construct(true, "UX", "add_to_cart", null, count($products));
        $this->setParameter(GAParameter::$PRODUCTACTION, 'add');
